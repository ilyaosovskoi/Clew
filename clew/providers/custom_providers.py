...
without modifying Clew source code.

Configuration: ~/.clew/providers.yaml
Plugin directory: ~/.clew/providers/
"""
...
DEFAULT_CONFIG_PATH = Path.home() / ".clew" / "providers.yaml"
...
def load_custom_provider_class(provider_config: Dict[str, Any]) -> Optional[Type[Provider]]:
    ...
    2. file_path: "~/.clew/providers/my_provider.py" — load from file
    """
...
def create_example_config() -> str:
    ...
    return """# ~/.clew/providers.yaml
# Custom provider configuration for Clew
#
...
#
# After editing, restart Clew or call registry.reload_custom_providers()
...
providers:
  ...
  - provider_id: "file_based_provider"
    file_path: "~/.clew/providers/my_provider.py"
