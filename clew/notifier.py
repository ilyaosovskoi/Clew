...
_CONFIG_PATH = os.path.expanduser("~/.clew/notifiers.json")
...
class Notifier:
    ...
    def configure_backend(self, name: str, config: Dict[str, Any]) -> Dict[str, Any]:
        """Configure or update a backend. Persists to ~/.clew/notifiers.json."""
        backend_classes: Dict[str, type] = {
            "telegram": TelegramBackend,
            "discord": DiscordBackend,
            "slack": SlackBackend,
