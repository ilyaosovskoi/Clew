"""
Clew v1.2.0 — Activity Log / Audit Trail
...
5. **The log is process-scoped, not chat-scoped.** Entries from
   ...
   restarts Clew. This lets the user audit "what did the agent do
...
# One log per Clew process. Created lazily on first access. Used by
