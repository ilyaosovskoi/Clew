...
the existing ``clew/daemon.py`` :class:`TaskQueue`.
...
This module is the inbound counterpart to ``clew/notifier.py`` (which
    ...
    def _on_message(msg: InboundMessage) -> None:
        try:
            ...
            if activity_log is not None:
                try:
                    from clew.activity_log import CATEGORY_INFO, STATUS_OK
                    activity_log.record(
