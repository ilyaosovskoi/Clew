...
Design:
  ...
  - Checkpoints are persisted in ~/.clew/checkpoints/<session_id>/ as JSON files.
...
Integration:
  ...
  - ClewBridge (TUI + GUI) exposes checkpoint/rewind/list_checkpoints/diff_checkpoints.
...
class FileManifestEntry:
    ...
    backup_path : str
        Absolute path to the backup file (under ~/.clew/checkpoints/<session>/backups/).
    checksum : str
