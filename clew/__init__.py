...
v2.0.0: Major refactoring.
       - New `clew.agent` package with v2 agent runtime (AgentRuntimeV2).
         ...
         * ACP server endpoint (clew-acp command, for IDE integration)
       - New `clew-native/` Cargo workspace with PyO3 bindings exposing
...
v1.3.0: Kimi Code-inspired agent architecture rewrite.
       ...
       - All Clew-unique features preserved: command whitelist, path
...
Clew-unique features preserved in v2.0:
- Multi-provider support (16 providers + AutoRouter)
- Qt GUI + QWebChannel + HTML frontend
