...
_BUILTIN_SKILLS: List[Skill] = [
    ...
    Skill(
        ...
        body=(
            ...
            "You create well-structured Word documents (.docx) using Clew's\n"
    ...
    Skill(
        ...
        body=(
            ...
            "You create Excel workbooks (.xlsx) using Clew's office_* tools.\n"
    ...
    Skill(
        ...
        body=(
            ...
            "You create PowerPoint decks (.pptx) using Clew's office_* tools.\n"
    ...
    Skill(
        ...
        body=(
            ...
            "you've made in this Clew session.\n\n"
